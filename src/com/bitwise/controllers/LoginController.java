...
import com.bitwise.authentication.Authentication;
...
public class LoginController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		flag=Authentication.validateValue(username);
		flag=Authentication.validateValue(password);
		...
		if(flag){
			...
			request.setAttribute("msg", "Please mention mandatory Fields");
		}
